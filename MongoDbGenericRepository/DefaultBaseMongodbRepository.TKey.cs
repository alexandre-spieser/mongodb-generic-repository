...
{
    public abstract class DefaultBaseTKeyMongodbRepository<TDocument, TKey> : BaseMongoRepository<TKey>, IDefaultBaseTKeyMongodbRepository<TDocument, TKey>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        #region ctor 
        protected DefaultBaseTKeyMongodbRepository()
        {
            InitRepository();
        }
        ...
        protected DefaultBaseTKeyMongodbRepository(string connectionString, string databaseName = null) : base(
        ...
        protected DefaultBaseTKeyMongodbRepository(IMongoDbContext mongodbContext) : base(mongodbContext)
        {
        }
        ...
        protected DefaultBaseTKeyMongodbRepository(IMongoDatabase mongodbDatabase) : base(mongodbDatabase)
        {
        }
        ...
        public virtual async Task<TDocument> GetByIdAsync(TKey id, string partitionKey = null) => await GetByIdAsync<TDocument>(id, partitionKey);
        ...
        /// <param name="id">The Id of the document you want to get.</param>
        /// <param name="partitionKey">An optional partition key.</param>
        public virtual TDocument GetById(TKey id, string partitionKey = null) => GetById<TDocument>(id, partitionKey);
        ...
        /// <param name="filter">A LINQ expression filter.</param>
        /// <param name="partitionKey">An optional partition key.</param>
        public async Task<List<TDocument>> QueryListAsync(Expression<Func<TDocument, bool>> filter, string partitionKey = null) => await GetAllAsync<TDocument>(filter, partitionKey);
