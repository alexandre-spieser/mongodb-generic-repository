...
{
    public abstract class DefaultBaseMongodbRepositoryTestBase<T> :
        IClassFixture<MongoDbTestFixture<T, Guid>>
        where T : TestDoc, new()
    {
        protected DefaultBaseMongodbRepositoryTestBase(MongoDbTestFixture<T, Guid> fixture)
        {
            _fixture = fixture;
            ...
            SUT = TestDefaultBaseMongodbRepository<T>.Instance;
        }
        ...
        /// </summary>
        protected static TestDefaultBaseMongodbRepository<T> SUT { get; set; }
